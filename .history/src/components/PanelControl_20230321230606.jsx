    ...
    <>
      ...
      <div className="flex justify-end items-center h-screen">
        <div className="flex flex-col items-center mx-4">
          ...
          <div className="flex flex-row items-center">
            <input type="text" className="w-48 p-2 border border-gray-300 rounded-t-md" onChange={handleInputEntry}/>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-l-md rounded-b-md" onClick={handleStepTape}>
              Step
            </button>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-r-md rounded-b-md" onClick={handleClickReset}>
              Reset
            </button>
          </div>
        </div>
