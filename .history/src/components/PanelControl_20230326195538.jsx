const PanelControl = ({
  ...
  return (
    <div className="">
      ...
      <div className="mt-4 ul-buttons">
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mr-2 rounded li-buttons"
        ...
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded li-buttons"
